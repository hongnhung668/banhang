...
<div class="mens">    
  <div class="main">
     <div class="wrap">
     	<ul class="breadcrumb breadcrumb__t"><a class="home" href="index.php">Home</a> /Single</ul>
		<div class="cont span_2_of_3">
            ...
            <?php
					...
					$sql = "select * from themmoi where Code = $id";
					$run = mysqli_query($conn,$sql);
					$row = mysqli_fetch_array($run);				
				 ?>
							<img src="img/<?php echo $row['Picture'] ?>" alt="<?php echo $row['Name'] ?>" width="360" height="300"  />	
						 <div class="clearfix"></div>
	            </div>
		         <div class="desc1 span_3_of_2">
                 
		         	<h3 class="m_3"><?php echo $row['Name'] ?></h3>
		             <p class="m_5"><?php echo $row['Money'] ?> đ</p>
				 <p class="m_5">Category: <?php echo $row['Category'] ?></p>
		         	 <div class="btn_form">
						<form>
							<a href="add.php?Code=<?php echo $row['Code'];?>">MUA</a>
						</form>
					 </div>
					<span class="m_link"><a href="login.php">login to save in wishlist</a> </span>
				     <p class="m_text2"><?php echo $row['Description']  ?></p>
			     </div>
			   <div class="clear"></div>	
	    <div class="clients">
