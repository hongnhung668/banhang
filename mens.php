        ...
        <div class="pager">   
     	...
     	<div class="clear"></div>
            ...
            <?php 
				...
				{
			?>
			 <div class="col_1_of_3 span_1_of_6"> 
			   <a href="single.php?id=<?php echo $row['Code']?>">
				<div class="inner_content clearfix" style="width:250px;height:330px">
					<div class="product_image">
						<img src="img/<?php echo $row['Picture'] ?>" width="250" height="233" alt=""/>
					</div>
                    <div class="price">
					   <div class="cart-left">
							<p class="title"><?php echo $row['Name'] ?></p>
							<div class="price1">
							  <span class="actual"><?php echo $row['Money'] ?> đ</span>
							</div>
						</div>
