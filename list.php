...
<body>
	...
	<div class="avatarBox col-sm-5 col-10 col-lg-5 mt-2 mt-lg-0 " style="margin-top: 20px;margin-bottom: 20px; margin-left:400px" >
	 <form method="post"><input type="search" name="txt_se">
	...
	<div class="container">
		...
		{
			$search=$_POST['txt_se'];
			$sql_search="select * from dangky where Name like '%$search%' or Address like '%$search%' or ID like '%$search%'";
		...
		<div>
				<tr>
					<th><a href="delete.php?xoa=<?php echo $row_search['ID'];  ?>" 
					onclick="if(confirm('Bạn có chắc chắn xóa không?')) return true; else return false;">Remove</a></th>
					<th> <?php echo $row_search['ID']; ?></th>
					<th><?php echo $row_search['Name']; ?></th>
					<th><?php echo $row_search['Address']; ?></th>
					<th><?php echo $row_search['Email']; ?></th>
				</tr>
		<?php	
			}
		}
		...
		<div>
				<tr>
					<th><a href="delete.php?xoa=<?php echo $row['ID'];  ?>" 
					onclick="if(confirm('Bạn có chắc chắn xóa không?')) return true; else return false;">Remove</a></th>
